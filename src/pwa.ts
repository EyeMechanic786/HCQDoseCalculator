...
function showInstallBanner(mode: 'install' | 'ios', onInstall?: () => void): void {
  ...
  if (mode === 'ios') {
    banner.innerHTML = `
      <p class="pwa-install-banner__text">
        ...
        <strong>Add to Home Screen</strong> for quick clinic access.
      </p>
    ...
    banner.innerHTML = `
      <p class="pwa-install-banner__text">
        <strong>Install app</strong> — open HCQ Dose Calculator from your home screen like a regular app.
      </p>
